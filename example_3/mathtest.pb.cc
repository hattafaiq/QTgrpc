...
static ::_pb::Metadata file_level_metadata_mathtest_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_mathtest_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_mathtest_2eproto = nullptr;

const uint32_t TableStruct_mathtest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_mathtest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_mathtest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_mathtest_2eproto = {
    false, false, 184, descriptor_table_protodef_mathtest_2eproto,
    "mathtest.proto",
    &descriptor_table_mathtest_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_mathtest_2eproto::offsets,
    file_level_metadata_mathtest_2eproto, file_level_enum_descriptors_mathtest_2eproto,
    file_level_service_descriptors_mathtest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_mathtest_2eproto_getter() {
  return &descriptor_table_mathtest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_mathtest_2eproto(&descriptor_table_mathtest_2eproto);
namespace mathtest {
...
::PROTOBUF_NAMESPACE_ID::Metadata MathRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_mathtest_2eproto_getter, &descriptor_table_mathtest_2eproto_once,
      file_level_metadata_mathtest_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata MathReply::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_mathtest_2eproto_getter, &descriptor_table_mathtest_2eproto_once,
      file_level_metadata_mathtest_2eproto[1]);
}
