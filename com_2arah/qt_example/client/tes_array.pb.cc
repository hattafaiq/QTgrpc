...
PROTOBUF_CONSTEXPR Mathhasil::Mathhasil(
  ...
  , /*decltype(_impl_._result_cached_byte_size_)*/{0}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_tes_5farray_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::mathtest::Mathhasil, _impl_.result_),
};
...
const ::_pbi::DescriptorTable descriptor_table_tes_5farray_2eproto = {
    false, false, 263, descriptor_table_protodef_tes_5farray_2eproto,
    "tes_array.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          _internal_add_result(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Mathhasil::_InternalSerialize(
  ...
  // repeated int32 result = 1;
  {
    int byte_size = _impl_._result_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
...
// @@protoc_insertion_point(message_byte_size_start:mathtest.Mathhasil)
  ...
  // repeated int32 result = 1;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int32Size(this->_impl_.result_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._result_cached_byte_size_.store(cached_size,
