...
class Mathhasil final :
 ...
 public:
  ...
  void clear_result();
  private:
  int32_t _internal_result(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_result() const;
  void _internal_add_result(int32_t value);
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > result_;
...
// repeated int32 result = 1;
inline int Mathhasil::_internal_result_size() const {
  return _impl_.result_.size();
}
inline int Mathhasil::result_size() const {
  return _internal_result_size();
}
inline void Mathhasil::clear_result() {
  _impl_.result_.Clear();
}
inline int32_t Mathhasil::_internal_result(int index) const {
  return _impl_.result_.Get(index);
}
inline int32_t Mathhasil::result(int index) const {
  // @@protoc_insertion_point(field_get:mathtest.Mathhasil.result)
  return _internal_result(index);
}
inline void Mathhasil::set_result(int index, int32_t value) {
  _impl_.result_.Set(index, value);
  // @@protoc_insertion_point(field_set:mathtest.Mathhasil.result)
}
inline void Mathhasil::_internal_add_result(int32_t value) {
  _impl_.result_.Add(value);
}
inline void Mathhasil::add_result(int32_t value) {
  _internal_add_result(value);
  // @@protoc_insertion_point(field_add:mathtest.Mathhasil.result)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
Mathhasil::_internal_result() const {
  return _impl_.result_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
Mathhasil::result() const {
  // @@protoc_insertion_point(field_list:mathtest.Mathhasil.result)
  return _internal_result();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
Mathhasil::_internal_mutable_result() {
  return &_impl_.result_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
Mathhasil::mutable_result() {
  // @@protoc_insertion_point(field_mutable_list:mathtest.Mathhasil.result)
