...
// string header = 3;
inline void MathRequest::clear_header() {
  _impl_.header_.ClearToEmpty();
}
inline const std::string& MathRequest::header() const {
  // @@protoc_insertion_point(field_get:mathtest.MathRequest.header)
  return _internal_header();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MathRequest::set_header(ArgT0&& arg0, ArgT... args) {
 
 _impl_.header_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:mathtest.MathRequest.header)
}
inline std::string* MathRequest::mutable_header() {
  std::string* _s = _internal_mutable_header();
  // @@protoc_insertion_point(field_mutable:mathtest.MathRequest.header)
  return _s;
}
inline const std::string& MathRequest::_internal_header() const {
  return _impl_.header_.Get();
}
inline void MathRequest::_internal_set_header(const std::string& value) {
  
  _impl_.header_.Set(value, GetArenaForAllocation());
}
inline std::string* MathRequest::_internal_mutable_header() {
  
  return _impl_.header_.Mutable(GetArenaForAllocation());
}
inline std::string* MathRequest::release_header() {
  // @@protoc_insertion_point(field_release:mathtest.MathRequest.header)
  return _impl_.header_.Release();
}
inline void MathRequest::set_allocated_header(std::string* header) {
  if (header != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mathtest.MathRequest.header)
}
...
// int32 a = 1;
inline void Mathhasil::clear_a() {
  _impl_.a_ = 0;
}
inline int32_t Mathhasil::_internal_a() const {
  return _impl_.a_;
}
inline int32_t Mathhasil::a() const {
  // @@protoc_insertion_point(field_get:mathtest.Mathhasil.a)
  return _internal_a();
}
inline void Mathhasil::_internal_set_a(int32_t value) {
  
  _impl_.a_ = value;
}
inline void Mathhasil::set_a(int32_t value) {
  _internal_set_a(value);
  // @@protoc_insertion_point(field_set:mathtest.Mathhasil.a)
}

// int32 b = 2;
inline void Mathhasil::clear_b() {
  _impl_.b_ = 0;
}
inline int32_t Mathhasil::_internal_b() const {
  return _impl_.b_;
}
inline int32_t Mathhasil::b() const {
  // @@protoc_insertion_point(field_get:mathtest.Mathhasil.b)
  return _internal_b();
}
inline void Mathhasil::_internal_set_b(int32_t value) {
  
  _impl_.b_ = value;
}
inline void Mathhasil::set_b(int32_t value) {
  _internal_set_b(value);
  // @@protoc_insertion_point(field_set:mathtest.Mathhasil.b)
}
