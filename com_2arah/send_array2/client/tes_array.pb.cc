...
const uint32_t TableStruct_tes_5farray_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mathtest::MathRequest, _impl_.header_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::mathtest::Mathhasil, _impl_.a_),
  PROTOBUF_FIELD_OFFSET(::mathtest::Mathhasil, _impl_.b_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 9, -1, -1, sizeof(::mathtest::MathReply)},
  { 16, -1, -1, sizeof(::mathtest::Mathhasil)},
};
...
const char descriptor_table_protodef_tes_5farray_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017tes_array.proto\022\010mathtest\"3\n\013MathReque"
  "st\022\t\n\001a\030\001 \001(\005\022\t\n\001b\030\002 \001(\005\022\016\n\006header\030\003 \001(\t"
  "\"\033\n\tMathReply\022\016\n\006result\030\001 \001(\005\"G\n\tMathhas"
  "il\022\t\n\001a\030\001 \001(\005\022\t\n\001b\030\002 \001(\005\022\016\n\006header\030\003 \001(\t"
  "\022\024\n\014result_float\030\004 \003(\0022\300\001\n\010MathTest\022;\n\013s"
  "endRequest\022\025.mathtest.MathRequest\032\023.math"
  "test.MathReply\"\000\0229\n\tsendarray\022\025.mathtest"
  ".MathRequest\032\023.mathtest.Mathhasil\"\000\022<\n\010s"
  "endchat\022\025.mathtest.MathRequest\032\023.mathtes"
  "t.Mathhasil\"\000(\0010\001b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_tes_5farray_2eproto = {
    false, false, 385, descriptor_table_protodef_tes_5farray_2eproto,
    "tes_array.proto",
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "mathtest.MathRequest.header"));
        } else
          goto handle_unusual;
        continue;
      default:
...
void Mathhasil::InternalSwap(Mathhasil* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Mathhasil, _impl_.b_)
      + sizeof(Mathhasil::_impl_.b_)
      - PROTOBUF_FIELD_OFFSET(Mathhasil, _impl_.a_)>(
          reinterpret_cast<char*>(&_impl_.a_),
          reinterpret_cast<char*>(&other->_impl_.a_));
}
