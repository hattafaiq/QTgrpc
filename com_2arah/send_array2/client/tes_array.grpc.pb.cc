...
MathTest::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_sendchat_(MathTest_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}
...
::grpc::ClientReaderWriter< ::mathtest::MathRequest, ::mathtest::Mathhasil>* MathTest::Stub::sendchatRaw(::grpc::ClientContext* context) {
  return ::grpc::internal::ClientReaderWriterFactory< ::mathtest::MathRequest, ::mathtest::Mathhasil>::Create(channel_.get(), rpcmethod_sendchat_, context);
}

void MathTest::Stub::async::sendchat(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::mathtest::MathRequest,::mathtest::Mathhasil>* reactor) {
  ::grpc::internal::ClientCallbackReaderWriterFactory< ::mathtest::MathRequest,::mathtest::Mathhasil>::Create(stub_->channel_.get(), stub_->rpcmethod_sendchat_, context, reactor);
}

::grpc::ClientAsyncReaderWriter< ::mathtest::MathRequest, ::mathtest::Mathhasil>* MathTest::Stub::AsyncsendchatRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::mathtest::MathRequest, ::mathtest::Mathhasil>::Create(channel_.get(), cq, rpcmethod_sendchat_, context, true, tag);
}

::grpc::ClientAsyncReaderWriter< ::mathtest::MathRequest, ::mathtest::Mathhasil>* MathTest::Stub::PrepareAsyncsendchatRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::mathtest::MathRequest, ::mathtest::Mathhasil>::Create(channel_.get(), cq, rpcmethod_sendchat_, context, false, nullptr);
}
...
MathTest::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::BidiStreamingHandler< MathTest::Service, ::mathtest::MathRequest, ::mathtest::Mathhasil>(
          [](MathTest::Service* service,
             ::grpc::ServerContext* ctx,
             ::grpc::ServerReaderWriter<::mathtest::Mathhasil,
             ::mathtest::MathRequest>* stream) {
               return service->sendchat(ctx, stream);
             }, this)));
}
...
::grpc::Status MathTest::Service::sendchat(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::mathtest::Mathhasil, ::mathtest::MathRequest>* stream) {
  (void) context;
  (void) stream;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
}
