  ...
  class WithCallbackMethod_ListFeatures : public BaseClass {
   ...
   public:
    WithCallbackMethod_ListFeatures() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackServerStreamingHandler< ::routeguide::Rectangle, ::routeguide::Feature>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::routeguide::Rectangle* request) { return this->ListFeatures(context, request); }));
    }
    ...
    virtual ::grpc::ServerWriteReactor< ::routeguide::Feature>* ListFeatures(
      ::grpc::CallbackServerContext* /*context*/, const ::routeguide::Rectangle* /*request*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_RecordRoute : public BaseClass {
   ...
   public:
    WithCallbackMethod_RecordRoute() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackClientStreamingHandler< ::routeguide::Point, ::routeguide::RouteSummary>(
            [this](
                   ::grpc::CallbackServerContext* context, ::routeguide::RouteSummary* response) { return this->RecordRoute(context, response); }));
    }
    ...
    virtual ::grpc::ServerReadReactor< ::routeguide::Point>* RecordRoute(
      ::grpc::CallbackServerContext* /*context*/, ::routeguide::RouteSummary* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
