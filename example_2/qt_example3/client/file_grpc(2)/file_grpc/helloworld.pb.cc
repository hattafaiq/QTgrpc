...
const uint32_t TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloRequest, _impl_.datablob_),
  ~0u,  // no _has_bits_
...
// @@protoc_insertion_point(message_byte_size_start:helloworld.HelloRequest)
  ...
  // repeated int32 size_arr = 3;
  {
    ...
    _impl_._size_arr_cached_byte_size_.store(cached_size,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.HelloReply.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 size_all = 2;
